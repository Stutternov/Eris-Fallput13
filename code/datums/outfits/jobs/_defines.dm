...
backpack_overrides[/decl/backpack_outfit/backpack]      = /obj/item/storage/backpack/satchel; \
backpack_overrides[/decl/backpack_outfit/backsport]     = /obj/item/storage/backpack/satchel; \
